...
> `https://github.com/<your_github_username>/macb.nvim.git`
...
```sh
git clone https://github.com/MacbClarke/macb.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/MacbClarke/macb.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/MacbClarke/macb.nvim.git "${env:LOCALAPPDATA}\nvim"
```
